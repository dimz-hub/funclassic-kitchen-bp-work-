...
const Footer = () => {
  ...
  return (
    ...
    <footer className='bg-black text-white pt-[20px] pb-[40px] w-full block border-none outline-none relative'>
      <div className='xl:flex justify-center  gap-[-100px]'>
      <div className='md:w-[70%]'>
      <div className='flex items-center  pt-[20px] lg:pt-[10px]  w-[95%] mx-auto'>
      ...
      <div>
        <p className='w-[90%] ml-[30px] mx-auto mt-[15px] md:w-[100%] xl:w-[60%] leading-8 text-[16px]'>
      ...
      <div className='mx-auto w-[95%] md:w-[100%] ml-[30px] mt-[25px]' id='contact'>
        ...
        <div className='flex items-center gap-3 mb-8'>
          ...
          <div  className="hover:underline break-all">
           6730 193a street V4N0B8
          </div>
        </div>
        </div>
        <div className='lg:flex justify-center xl:block'>
          <iframe 
  ...
  style={{border:"0"}} 
  allowFullScreen="" 
  className='w-[85vw] lg:w-[70vw] xl:w-[30vw]  xs:h-[350px] xs:rounded-[20px] xs:mb-[20px]  h-[300px] xl:mt-[-35px] md:h-[400px] xl:h-[300px] rounded-xl' 
  loading="lazy" 
...
></iframe>
       ...
       <div>
          ...
          <div className='flex items-center justify-center text-white text-[16px] mt-[15px]'>
                Copyright &copy; {currentYear}<div className='bg-white mx-[5px] w-[5px] h-[5px] rounded-[50%]'> </div> <span className='text-orange-500 font-semibold'>FunClassic Kitchen</span>
            </div>
          </div>
        </div>
    </footer>
